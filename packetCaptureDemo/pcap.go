...
func main() {
	// send http/https traffic to nfqueue queue 100
	// # sudo iptables -I OUTPUT -p tcp --dport 80 -j NFQUEUE --queue-num 100
	// # sudo iptables -I OUTPUT -p tcp --dport 443 -j NFQUEUE --queue-num 100
